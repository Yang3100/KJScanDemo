...
- (void)viewDidLoad {
    ...
    [right_button setTitleColor:UIColor.blueColor forState:(UIControlStateNormal)];
    [right_button addTarget:self action:@selector(back) forControlEvents:UIControlEventTouchUpInside];
    right_button.titleLabel.font = [UIFont systemFontOfSize:16];
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithCustomView:right_button];
